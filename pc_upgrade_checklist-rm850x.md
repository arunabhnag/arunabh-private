...
| Component | Out | In |
|---|---|---|
| PSU | EVGA 700GD | Corsair RM850x (2024) |
...
> - The 9070XT Nitro+ uses **2x 6-pin PCIe** connectors — the RM850x (2024) includes a native 12V-2x6 connector cable, which is compatible
> - **Never mix modular cables between PSU brands** — use only the Corsair-included cables
> - The RM850x has a **fan speed adjustment knob** on the rear panel — leave it in Auto/default position unless you need manual override
...
### Install Corsair RM850x (2024)
- [ ] Slide the RM850x in with **fan facing DOWN** (toward bottom mesh vent), power socket and fan knob facing rear
- [ ] Secure with the 4 included screws
- [ ] Reattach PSU shroud
- [ ] Connect cables using **only the Corsair-included cables**:
...
- [ ] Connect the **2x 6-pin PCIe** connectors — the RM850x (2024) includes a native 12V-2x6 cable; use a dedicated cable run rather than daisy-chaining both connectors off one cable
